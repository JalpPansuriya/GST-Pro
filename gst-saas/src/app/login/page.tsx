                ...
                <div className="relative z-10 flex flex-col justify-center px-16 text-white">
                    ...
                    >
                        ...
                        <p className="text-xl text-white/80 mb-8">
                            Simplify your GST compliance with automated filing, ITC tracking, and smart invoice management.
                        </p>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                'Real-time ITC tracking & reconciliation',
                                'Excel & PDF invoice upload',
                                'Multi-GSTIN support',
                            ].map((feature, index) => (
                                <motion.div
                                    key={feature}
            ...
            >
                <div className="w-full max-w-md">
                    ...
                    <div className="lg:hidden mb-8 text-center">
                        ...
                        <h1 className="text-2xl font-bold gradient-text">GST Pro</h1>
                    </div>
